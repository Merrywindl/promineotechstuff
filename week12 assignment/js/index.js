...
$(document).ready(function () {
    ...
    const render = async () => {
      //fetch all funkos from the server
      const funkos = await fetchfunkos();
      // console.log("funkos from render", { funkos });
  
      // Clear the current list
      $("#todoList").empty();
  
      // Loop through the funkos array and append each todo to the list
      funkos.forEach(function (todo, index) {
